package com.MazeGenerator.util;
...
public class ClassFinder {
	...
	public static final Class<? extends Object>[] getClasses(String packageName)
	    ...
	    for (File directory : dirs) {
	        classes.addAll((Collection<? extends Class<? extends Object>>) findClasses(directory, packageName));
	    }
