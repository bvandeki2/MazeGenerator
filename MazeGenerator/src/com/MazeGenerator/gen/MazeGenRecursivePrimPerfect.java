...
public class MazeGenRecursivePrimPerfect extends MazeGenerator {
	private static final MazeGenerator instance = new MazeGenRecursivePrimPerfect();
	
	public static final String name = "Prim's Algorithm (Perfect)";
